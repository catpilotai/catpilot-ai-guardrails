...
files here match those hashes byte for byte, preserving the published
report's inputs for audit.
...
Retired on publication. Do not re-run these in any comparison.
