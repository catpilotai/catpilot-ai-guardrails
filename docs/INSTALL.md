...
Installation makes the instructions available to a host; it does not prove they were loaded, followed, or enforced. See the tested-runtimes table in the README.
