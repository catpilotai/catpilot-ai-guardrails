...
| Safe-building evaluation fixtures and with/without runner | shipped; a two-scenario Codex smoke report is published in `evals/reports/`; a full with/without report is not yet |
