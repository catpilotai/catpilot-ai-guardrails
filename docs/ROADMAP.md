...
| Safe-building evaluation fixtures and with/without runner | shipped: two benchmark pairs published (`2026.09.15`, `2026.09.16-1`); the design is frozen until the skill, the overlay, or a host changes materially |
