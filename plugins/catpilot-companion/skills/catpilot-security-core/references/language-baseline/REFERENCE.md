...
Use the tested POSIX examples in [safe_io.py](../../scripts/language-baseline/safe_io.py)
(`read_file_in_directory`) and [safe_files.cjs](../../scripts/language-baseline/safe_files.cjs)
...
See [safe_io.py](../../scripts/language-baseline/safe_io.py), `request_public_json`, for a tested
